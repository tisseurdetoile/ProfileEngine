 ...
 */
public class AttributeValueIsGreaterTest extends TestCase {
    
    public AttributeValueIsGreaterTest(String testName) {
        super(testName);
    }
    ...
    public void testIsSatisfiedBy() {
        ...
        AbstractHashSpecification spec = new AttributeValueIsGreater(param, "10");
