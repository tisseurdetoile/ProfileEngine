 ...
 * @author 11646n
 */
public class AttributeValueIsLesser extends AbstractHashSpecification {

    public AttributeValueIsLesser(String paramName, String ParamValue, boolean nullIsZero) {
    ...
    public AttributeValueIsLesser(String paramName, String ParamValue) {
